...
if ( ! class_exists( 'WP_Async_Request', false ) ) {
    include_once $theme_dir . '/includes/libraries/wp-async-request.php';
}

if ( ! class_exists( 'WP_Background_Process', false ) ) {
    include_once $theme_dir . '/includes/libraries/wp-background-process.php';
}

/**
 * Apalodi_Background_Process class.
 */
abstract class Apalodi_Background_Process extends WP_Background_Process {
    ...
    /**
     * First dispatch only if there is data.
     *
     * @access public
     * @return void
     */
    public function first_dispatch() {
     ...
     * Delete all batches.
     *
     * @return Apalodi_Background_Process
     */
